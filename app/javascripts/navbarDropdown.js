document.write(
		...
		'        <span class="icon-bar"></span> '+
		'      </button>'+
		'    <a class="navbar-brand" href="/" target="blank"><span class="glyphicon glyphicon-grain"></span> Mharo Vyapaar </a>'+
		'    </div>'+
		'    <div class="collapse navbar-collapse" id="myNavbar">'+
		'      <ul class="nav navbar-nav">'+
		'      <li><a href="index.html"><span class="glyphicon glyphicon-home"></span> Home</a></li>'+
		'      <li class="dropdown-submenu">'+
		'          <a class="dropdown-toggle" data-toggle="dropdown" href="payment.html"><span class="glyphicon glyphicon-check"></span> Tasks</a>'+
		'          <ul class="dropdown-menu">'+
		'          <li><a href="newTask.html"><span class="glyphicon glyphicon-share"></span> New Task</a></li> '+
		'          <li><a href="tasks.html"><span class="glyphicon glyphicon-list-alt"></span> View Tasks</a></li>        '+
		...
		'        <li><a href="community.html"><span class="glyphicon glyphicon-home"></span> Community</a></li> '+
